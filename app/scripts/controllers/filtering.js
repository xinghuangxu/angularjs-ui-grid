 ...
 */
angular.module('uiGridApp').controller('FilteringCtrl', ['$scope', '$http', 'uiGridConstants', function ($scope, $http, uiGridConstants) {
    var today = new Date();
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [
            // default
            { field: 'name', headerCellClass: $scope.highlightFilteredHeader,enableColumnResizing: true },
